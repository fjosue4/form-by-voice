...
import nameAudio from '../../audio/name.wav';
...
function AskName () {
    ...
    const {
      ...
      transcript && dispatch(transcriptionActions.updateNameId(transcript));
      dispatch(updateRec.updateRecPage(2))
    }
    ...
    return(
        <div className="center-box">
            ...
            <p>Up to 5 seconds</p>
            <audio autoplay="true" src={nameAudio}></audio>
        </div>
    )
}
